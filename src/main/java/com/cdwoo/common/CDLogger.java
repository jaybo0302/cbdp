 ...
 * 
 */
public final class CDLogger {
  private static final String FQCN = CDLogger.class.getName();
  private static final Logger logger = (Logger) LoggerFactory.getLogger(CDLogger.class);
  private CDLogger() {
  }
   ...
   * 输出error级别信息
   * 
   * @see CDLogger.error(String msg, Throwable t) {
   * 
   * @param e
   *        异常
   */
